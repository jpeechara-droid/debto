    ...
    <div className="min-h-screen flex">
      ...
      >
        ...
        <div className="flex flex-col gap-5 mb-12">
          {[
            "Free personalized debt analysis",
            "Clear roadmaps to zero debt",
            "Certified financial counselor support",
          ].map((item) => (
            <div key={item} className="flex items-center gap-3">
              <span className="material-symbols-outlined text-secondary-blue fill-1">
                check_circle
              </span>
        ...
        <div className="bg-white/5 rounded-2xl border border-white/10 p-6 max-w-sm">
          <div className="flex items-end gap-3 h-32">
            {[40, 60, 50, 70, 85, 95].map((h, i) => (
              <motion.div
                key={i}
                className={`flex-1 rounded-t ${
                  i >= 4 ? "bg-cta-saffron" : "bg-white/20"
                }`}
                initial={{ height: 0 }}
                animate={{ height: `${h}%` }}
          ...
          <div className="flex items-center gap-2 mt-3">
            <div className="h-2 w-2 bg-cta-saffron rounded-full" />
            <div className="h-2 w-2 bg-cta-saffron rounded-full" />
          </div>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        ...
        >
          ...
          <p className="text-slate-500 mb-8">
            Sign up to get your free debt analysis.
          </p>
          ...
          <p className="text-center text-xs text-slate-400 mt-8 leading-relaxed">
            ...
            <a href="#" className="text-secondary-blue hover:underline">
              Terms of Service
            </a>{" "}
            and{" "}
            <a href="#" className="text-secondary-blue hover:underline">
            ...
            . We will never share your personal information without your
            explicit consent.
          </p>
        </motion.div>
      </div>
